<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ImprimirReportesGanancias.aspx.cs" Inherits="Almacen2._0.Views.Reportes.ImprimirReportesGanancias" %>
        ...
        <div class="col-xs-10 table-responsive" style="margin-left:25px">          
            <asp:GridView ID="GridView1" OnRowCommand="GridView1_RowCommand" CssClass="table1 table table-responsive" runat="server" AutoGenerateColumns="false">
                    <Columns>
                        ...
                        <asp:BoundField HeaderStyle-CssClass="text-center" DataField="Tipo_pago.descripcion" HeaderText="Id Pago" />  
                    </Columns>
